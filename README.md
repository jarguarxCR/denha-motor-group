...
เปิด `Admin Demo` แล้วใช้ปุ่ม `ดาวน์โหลดข้อมูล` เพื่อส่งออกสินค้าเป็น `.xlsx` หรือ `อัปโหลดข้อมูล` เพื่อนำเข้าข้อมูลสินค้าแบบเพิ่ม/อัปเดต ไฟล์ Excel จัดการเฉพาะข้อมูล ไม่รวมรูปภาพ และใช้ `รหัสสินค้า` เป็นตัวจับคู่รายการเดิม
